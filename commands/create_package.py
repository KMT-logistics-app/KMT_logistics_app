...
class CreatePackageCommand:
    ...
    def execute(self):
        ...
        start_location, delivery_adress, weight, name, email = self._params
        weight = try_parse_float(weight)
        self._app_data.create_package(start_location, delivery_adress, weight, name)
        ...
        return f"Package from {name} was created."
